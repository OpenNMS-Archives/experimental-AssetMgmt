 ...
 */
public class VendorManager extends AssetSelectorManager {

    public VendorManager() {
        setAllQueryString("select v from Vendor as v order by v");
        setSelectionName(AssetSelector.computeSelectionName(Vendor.TYPE_NAME));
        setSelectionClass(Vendor.class);
    }

 ...
 */
public class OperatingSystemManager extends AssetSelectorManager {

    public OperatingSystemManager() {
        setAllQueryString("select o from OperatingSystem as o order by o");
        setSelectionName(AssetSelector
                .computeSelectionName(OperatingSystem.TYPE_NAME));
        setSelectionClass(OperatingSystem.class);

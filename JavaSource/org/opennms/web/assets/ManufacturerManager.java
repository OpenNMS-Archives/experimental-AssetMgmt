 ...
 */
public class ManufacturerManager extends AssetSelectorManager {

    public ManufacturerManager() {
        setAllQueryString("select m from Manufacturer as m order by m");
        setSelectionName(AssetSelector
                .computeSelectionName(Manufacturer.TYPE_NAME));
        setSelectionClass(Manufacturer.class);

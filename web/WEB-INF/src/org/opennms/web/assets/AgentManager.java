 ...
 */
public class AgentManager extends AssetSelectorManager {

    public AgentManager() {
        setAllQueryString("select a from Agent as a order by a");
        setSelectionName(AssetSelector.computeSelectionName(Agent.TYPE_NAME));
        setSelectionClass(Agent.class);
